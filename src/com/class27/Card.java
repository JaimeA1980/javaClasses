package com.class27;
/* define a class cared with 2 methods and this class should have 4
 * subclasses in which some behavior can be overridden and some can impliment
 * it is own behavior
 */
...
class AX extends Card {
	public void creditLimit() {// overriding
		System.out.println("Credit limit of the cards is 25000");
	}
}
